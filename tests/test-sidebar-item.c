...
static void
test_adw_sidebar_item_get_index (void)
{
  AdwSidebarSection *section = adw_sidebar_section_new ();
  ...
  g_assert_cmpint (adw_sidebar_item_get_index (item1), ==, 0);
  g_assert_cmpint (adw_sidebar_item_get_index (item2), ==, 0);
  g_assert_cmpint (adw_sidebar_item_get_index (item3), ==, 0);
  ...
  g_assert_cmpint (adw_sidebar_item_get_index (item1), ==, 1);
  g_assert_cmpint (adw_sidebar_item_get_index (item2), ==, 0);
  g_assert_cmpint (adw_sidebar_item_get_index (item3), ==, 0);
  ...
  g_assert_cmpint (adw_sidebar_item_get_index (item1), ==, 1);
  g_assert_cmpint (adw_sidebar_item_get_index (item2), ==, 0);
  g_assert_cmpint (adw_sidebar_item_get_index (item3), ==, 2);
      ...
      char *argv[])
{
  ...
  g_test_add_func("/Adwaita/SidebarItem/get_index", test_adw_sidebar_item_get_index);
