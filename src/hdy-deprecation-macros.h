...
#  define _HDY_DEPRECATED_MACRO          G_DEPRECATED_MACRO
#  define _HDY_DEPRECATED_MACRO_FOR(f)   G_DEPRECATED_MACRO_FOR(f)
#  define _HDY_DEPRECATED_ENUMERATOR          G_DEPRECATED_ENUMERATOR
#  define _HDY_DEPRECATED_ENUMERATOR_FOR(f)   G_DEPRECATED_ENUMERATOR_FOR(f)
#  define _HDY_DEPRECATED_TYPE           G_DEPRECATED_TYPE
#  define _HDY_DEPRECATED_TYPE_FOR(f)    G_DEPRECATED_TYPE_FOR(f)
#endif
